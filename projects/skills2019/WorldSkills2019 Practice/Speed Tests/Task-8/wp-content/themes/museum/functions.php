...
if ( ! function_exists( 'museum_setup' ) ) :
	...
	function museum_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'museum' ),
		) );
...
function museum_scripts() {
	...
	wp_enqueue_script( 'museum-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'museum-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
